...
Based off of these prices, Sectors A and B will only need `r round(a_cnt_demand, 2)` and `r round(b_cnt_demand, 2)` tons respectively. Sector C however has a demand of `r round(c_cnt_demand, 2)` tons, therefore they will purchase the remaining credits from Sectors A and B. 
