...
```{r tax_answer}
#(1) Total cost (equals tax revenue?)

total_cost_tax <-  integrate(carbon_a_fun_demand, carbon_a_fun_demand(tax$sector_a),current_a)$value+
  integrate(carbon_b_fun_demand,carbon_b_fun_demand(tax$sector_b),current_b)$value+
  integrate(carbon_c_fun_demand,carbon_c_fun_demand(tax$sector_c),current_c)$value

#(2) Sector Cost 

sector_a_cost_tax <- integrate(carbon_a_fun_demand, carbon_a_fun_demand(tax$sector_a),current_a)$value+
sector_b_cost_tax <- integrate(carbon_b_fun_demand,carbon_b_fun_demand(tax$sector_b),current_b)$value+
sector_c_cost_tax <- integrate(carbon_c_fun_demand,carbon_c_fun_demand(tax$sector_c),current_c)$value
...
```{r}
#Calculate equilibrium points for both Sectors A and C using uniroot

equi_sector_a <- uniroot(function(Q){carbon_a_fun(Q)-carbon_a_fun_demand(Q)},
                         interval = c(0,300),
                         extendInt = "yes")

# Equi point for B calculated to show that it is at 100 tons carbon, which checks out
equi_sector_b <- uniroot(function(Q){carbon_b_fun(Q)-carbon_b_fun_demand(Q)},
                         interval = c(0,300),
                         extendInt = "yes")

equi_sector_c <- uniroot(function(Q){carbon_c_fun(Q)-carbon_c_fun_demand(Q)},
                         interval = c(0,300),
                         extendInt = "yes")
