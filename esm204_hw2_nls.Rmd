...
total_cost <-  integrate(carbon_a_fun_demand, 0, tax$sector_a)$value+
  integrate(carbon_b_fun_demand,0,tax$sector_b)$value+
  integrate(carbon_c_fun_demand,0,tax$sector_c)$value

#(2) Sector Cost 

sector_a_cost_tax <- integrate(carbon_a_fun_demand,0,tax$sector_a)
sector_b_cost_tax <- integrate(carbon_b_fun_demand,0,tax$sector_b)
sector_c_cost_tax <- integrate(carbon_c_fun_demand,0,tax$sector_c)
