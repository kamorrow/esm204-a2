...
sector_a_cost_tax <- integrate(carbon_a_fun_inv,carbon_a_fun_demand(tax$mc),current_a)$value
sector_b_cost_tax <- integrate(carbon_b_fun_inv,carbon_b_fun_demand(tax$mc),current_b)$value
sector_c_cost_tax <- integrate(carbon_c_fun_inv,carbon_c_fun_demand(tax$mc),current_c)$value
