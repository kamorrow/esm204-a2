...
#(1,3) Total cost (equals tax revenue?)

total_cost <-  integrate(carbon_a_fun_demand,0,tax$sector_a)+
  integrate(carbon_b_fun_demand,0,tax$sector_b)+
  integrate(carbon_c_fun_demand,0,tax$sector_c)
